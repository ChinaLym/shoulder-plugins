...
//			// 过滤掉null元素
//			return null == values ? 0 :sum(Collections2.filter(values, Objects::nonNull).toArray(new Type[0]));
//		}
//		public static int sumOfString(Collection<String>values){
//			return null == values ? 0 :sum(Collections2.transform(values, input -> {
//				try{
...
//	}
//	/**
//	 * 在{@link ClassDoc}中查找与name匹配的{@link com.sun.tools.javadoc.FieldDocImpl}<br>
