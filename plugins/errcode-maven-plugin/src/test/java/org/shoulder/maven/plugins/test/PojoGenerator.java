...
public class PojoGenerator extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException {
        ...
        for (Map.Entry<JavaClassSource, String> pojoEntry : pojos.entrySet()) {
    ...
    private Map<JavaClassSource, String> createPojos(Map<JavaInterfaceSource, String> interfaces) {
        ...
        for (Map.Entry<JavaInterfaceSource, String> srcEntry : interfaces.entrySet()) {
            ...
            pojo.addAnnotation(JsonInclude.class).setEnumValue(JsonInclude.Include.NON_NULL);
